...
const PricingPage = () => {
  return (
    <div className="relative bg-gradient-to-br from-slate-50 via-white to-emerald-50/40 py-24 sm:py-32 lg:py-40 overflow-hidden">
      {/* Enhanced decorative background */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Large gradient orbs */}
        <div className="absolute -top-40 -right-40 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-emerald-200/20 via-teal-200/20 to-green-200/20 blur-3xl animate-pulse"></div>
        <div
          className="absolute -bottom-40 -left-40 h-[600px] w-[600px] rounded-full bg-gradient-to-br from-teal-200/20 via-cyan-200/20 to-emerald-200/20 blur-3xl animate-pulse"
        ...
        {/* Subtle grid overlay */}
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 32 32%22 width=%2232%22 height=%2232%22 fill=%22none%22 stroke=%22rgb(148 163 184 / 0.05)%22%3E%3Cpath d=%22m0 .5 32 0%22/%3E%3Cpath d=%22m0 32.5 32 0%22/%3E%3Cpath d=%22m.5 0 0 32%22/%3E%3Cpath d=%22m32.5 0 0 32%22/%3E%3C/svg%3E')] opacity-60"></div>
      </div>

      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        {/* Badge */}
        <div className="mx-auto max-w-2xl text-center mb-8">
          <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-100 to-teal-100 px-6 py-3 text-sm font-medium text-emerald-700">
              ...
              >
                <Card
                  className={`group relative transition-all duration-500 hover:shadow-3xl hover:-translate-y-4 ${
                    plan.popular
                      ? "ring-4 ring-emerald-500/50 shadow-2xl scale-105 bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/20"
                      : "shadow-xl bg-white hover:shadow-2xl overflow-hidden"
                  }`}
                >
                  ...
                  {plan.popular && (
                    <>
                      ...
                      {/* Subtle inner glow */}
                      <div className="absolute inset-2 rounded-lg bg-gradient-to-br from-emerald-50/50 via-teal-50/30 to-green-50/20 opacity-60"></div>
                    </>
                  )}
                  ...
                  <CardHeader className="relative text-center pb-10 pt-8">
                    ...
                    <CardDescription className="mt-6 text-lg text-gray-600 max-w-xs mx-auto">
                      {plan.description}
                    </CardDescription>
                  </CardHeader>
                    ...
                    <ul className="space-y-5">
                      {plan.features.map((feature, featureIndex) => (
                        <li key={feature} className="flex items-start gap-x-4">
                          <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-green-100 to-emerald-100 mt-0.5 flex-shrink-0">
